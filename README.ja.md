...
> *「LLMがロボットの頭脳」* — Jetson Orin NX 上のローカル推論による、オンデバイス意味理解。
...
### 多言語対話
- **日本語優先**: 日本語会話に最適化（ホットキャッシュ、応答検証、ASR）
- **多言語対応アーキテクチャ**: Qwen2.5-7B は日本語・中国語・英語をネイティブに理解
- **ASR言語切替**: Whisper の言語パラメータをセッションごとに設定可能
